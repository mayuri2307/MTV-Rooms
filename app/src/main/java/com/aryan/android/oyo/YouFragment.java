...
public class YouFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView fb1=(TextView) view.findViewById(R.id.feedback);
        fb1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent browse=new Intent(Intent.ACTION_VIEW,Uri.parse("https://docs.google.com/forms/d/e/1FAIpQLSev-1xKsgBlmzZPHmsbDx36Y5lD1_6TlkOwcNDSZ2gWvYIDZg/viewform?usp=sf_link"));
        ...
        pr1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(),profile_you.class);
                startActivity(intent);
            }
        });
        ...
        TextView btn1=(TextView) view.findViewById(R.id.chat_roommate);
