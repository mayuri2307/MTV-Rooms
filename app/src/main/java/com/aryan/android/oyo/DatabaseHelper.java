...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_HOTEL_TABLE = "CREATE TABLE " + TABLE_ADD + "(" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_NAME + " TEXT," + COLUMN_LOCATIONS
            ...
            + COLUMN_RATINGS+" INTEGER DEFAULT 0 NOT NULL,"+COLUMN_DESCRIPTION+" TEXT,"+COLUMN_RATING+"INTEGER DEFAULT 0 NOT NULL" + ")";
  ...
  public void addRoom(Room room) {
       ...
       values.put(COLUMN_LOCATIONS, room.getLocation());
       values.put(COLUMN_RATES, room.getRate());
       values.put(COLUMN_COST, room.getCost());
       values.put(COLUMN_DISCOUNTS, room.getDiscount());
       values.put(COLUMN_RATINGS, room.getRating());
       values.put(COLUMN_DESCRIPTION, room.getDescription());
       values.put(COLUMN_RATING, room.getRatings());
