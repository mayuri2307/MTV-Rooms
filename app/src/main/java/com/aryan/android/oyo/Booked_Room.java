...
public class Booked_Room extends RecyclerView.Adapter<Booked_Room.HotelItemViewHolder> {
    ...
    public class HotelItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public HotelItemViewHolder(View itemView,Booked_Room adapter) {
            super(itemView);
    ...
    public Booked_Room(Context context,TypedArray mHotelImages,List<Integer> mFavouriteImages,String mCity,List<String> mRommIds,List<String> mHotelNames,
    ...
    @Override
    public Booked_Room.HotelItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mItemView = mInflater.inflate(R.layout.hotels_list_item, parent, false);
        return new Booked_Room.HotelItemViewHolder(mItemView, this);
    }

    @Override
    public void onBindViewHolder(final Booked_Room.HotelItemViewHolder holder, final int position) {
        final int mCurentHotelImage = mHotelImages.getResourceId(position,-1);
        Log.d("Image id1",mCurentHotelImage+"");
        final int mCurrentFavouriteImage = mFavouriteImages.get(position);
        final String mCurrentRoomId = mRoomIds.get(position);
        final String mCurrentHotelName = " " + mHotelNames.get(holder.getAdapterPosition()) ;
