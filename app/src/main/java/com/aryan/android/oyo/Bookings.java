...
public class Bookings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setnames =  this.getActivity().getSharedPreferences("PREFERENCE", MODE_PRIVATE)
        ...
        //Log.d("may",show);
        if(show!=null && show.equals("true")&&setnames!=null&&setnames.size()>0){
            Log.d("Hidee","hide");
            View hide = view.findViewById(R.id.book_now);
            ((ViewGroup) hide.getParent()).removeView(hide);
            View hide1 = view.findViewById(R.id.bookings_fragment_txt_1);
            ((ViewGroup) hide1.getParent()).removeView(hide1);
            View hide2 = view.findViewById(R.id.img_bookings);
